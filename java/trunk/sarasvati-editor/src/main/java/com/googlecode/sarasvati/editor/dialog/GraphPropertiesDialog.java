...
import com.googlecode.sarasvati.editor.panel.GraphPropertiesPanel;

public class GraphPropertiesDialog extends JDialog
{
  private static final long serialVersionUID = 1L;

  public GraphPropertiesDialog (final JFrame frame,
                                final EditorGraph graph)
  {
    ...
    GraphPropertiesPanel panel = new GraphPropertiesPanel();
    panel.setup( this, graph );
